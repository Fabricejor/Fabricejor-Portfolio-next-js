...
export const PinContainer = ({
  ...
  return (
    <Link
      className={cn(
        "relative group/pin z-20 cursor-pointer w-full h-[100vh] block",
        containerClassName
      )}
    ...
    >
      <div
        ...
        className="absolute left-1/2 top-1/2   max-w-[100%] max-h-[100%] -translate-x-1/2 -translate-y-1/2 w-[100%] h-[100%]"
      >
        <div
          style={{
            transform: transform,
          }}
          className="absolute left-1/2 p-2 top-1/2 w-full h-[100vh] flex justify-start items-start rounded-2xl shadow-[0_8px_16px_rgb(0_0_0/0.4)] bg-black border border-white/[0.1] group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden"
        >
      ...
      <div className="w-full h-full -mt-7 flex-none inset-0">
        <div className="absolute top-10 inset-x-0 flex justify-center">
          <div className="relative flex space-x-2 items-center z-10 rounded-full bg-zinc-950 py-0.5 px-4 ring-1 ring-white/10">
            <span className="relative z-20 text-white text-sm font-bold inline-block py-0.5">
              {title}
            </span>
